...
const NAV_ITEMS = [
  { id: "ai",         icon: "M8.625 9.75c0 .621.504 1.125 1.125 1.125h1.5c.621 0 1.125-.504 1.125-1.125V5.25h-3.75v4.5Zm-3.75 3c0 .621.504 1.125 1.125 1.125h1.5c.621 0 1.125-.504 1.125-1.125v-7.5h-3.75v7.5Z" },
  { id: "trackers",   icon: "M12 2a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-2 4a2 2 0 1 1 4 0 2 2 0 0 1-4 0Zm5.658 7.757A8.974 8.974 0 0 0 12 13a8.974 8.974 0 0 0-6.658 2.757A3.959 3.959 0 0 0 4 18.5v.8c0 .387.313.7.7.7h14.6c.387 0 .7-.313.7-.7v-.8c0-1.06-.422-2.076-1.172-2.826Z" },
  { id: "library",     icon: "M4 4.5A2.5 2.5 0 0 1 6.5 2h11A2.5 2.5 0 0 1 20 4.5v15a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 19.5v-15Z" },
      ...
      {visibleItems.map((item) => {
        ...
        return (
          ...
          >
            ...
            <span className="truncate">{t[LABELS[item.id]]}</span>
          </button>
        );
      })}
