      ...
      <div className="flex items-center gap-1">
        {user && (
          <div className="flex items-center gap-2 mr-2 text-xs">
            <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg bg-gray-100 dark:bg-white/5">
            ...
            {user.role === "admin" && (
              <span className="text-[10px] px-1.5 py-0.5 rounded bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 font-medium">Admin</span>
            )}
          </div>
        )}
